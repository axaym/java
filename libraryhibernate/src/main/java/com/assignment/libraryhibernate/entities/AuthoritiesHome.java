...
// default package
// Generated Jan 14, 2019 8:11:48 AM by Hibernate Tools 5.3.0.Beta2
...
public class AuthoritiesHome {
	...
	public Authorities findById(AuthoritiesId id) {
		...
		try {
			Authorities instance = (Authorities) sessionFactory.getCurrentSession().get("Authorities", id);
			if (instance == null) {
	...
	public List findByExample(Authorities instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("Authorities")
